...
const Product = ({ ProductPromise, addToCart, cart, removeItem, checkout }) => {
  ...
  return (
    <div className='w-[1200px] mx-auto pt-[120px] pb-[120px]'>
      ...
      {/* Toggle */}
      <div className='flex justify-center gap-6 w-[290px] mx-auto my-6'>

        <button
          onClick={() => setSelectedType("available")}
          className={`${selectedType === "available"
            ? "tab rounded-full w-40 h-15 py-4 text-white font-bold bg-[linear-gradient(89.15deg,#4F39F6_-30.76%,#9514FA_99.27%)]"
            : ""}`}
        >
          Products
        </button>
